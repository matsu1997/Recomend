...
class _VState extends State<V> {
  var password = "";
  var Ken = "";var Shityo = "";var Rosen = "";var Eki = "";
  var tap = 0;
  var item = [];
  var SearchItem = [];
  var aka = false;
      ...
      body: DefaultTabController(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title:Text("さがす",style: TextStyle(fontWeight: FontWeight.bold,color:Colors.black),),
            iconTheme: IconThemeData(color: Colors.black),
            centerTitle: true,
            actions: [IconButton(onPressed: (){pop();}, icon: Icon(Icons.search),)],
            bottom: const TabBar(
              tabs: [
                Tab(child: Text("治療",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black),),),
                Tab(child: Text("エステ",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black),),),
                    ],
            ),),
          body: TabBarView(children: [V1("治療"),V1("エステ"),],
          ),),),);}

  void pop(){
    showDialog(context: context, builder: (context) => AlertDialog(
      actions: <Widget>[SingleChildScrollView(child:Column(children: [
        Container(width:double.infinity,height: 20 ,margin: EdgeInsets.only(top:5), child: Text("都道府県",style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 15),textAlign: TextAlign.center,),),
        Container(width:double.infinity,height: 40 ,color: Colors.grey[100],margin: EdgeInsets.all(10),child:TextFormField(onTap: () {item =["道央","道南","道北","オホーツク","十勝","釧路・根室","青森県","岩手県","秋田県","宮城県","山形県","福島県","新潟県","富山県","石川県","福井県","山梨","長野県","栃木県","群馬県","茨城県","埼玉県","東京都","千葉県","神奈川県","岐阜県","静岡県","愛知県","三重県","滋賀県","京都府","大阪府","兵庫県","奈良県","和歌山県","鳥取県","島根県","岡山県","広島県","山口県","徳島県","香川県","愛媛県","高知県","福岡県","佐賀県","長崎県","熊本県","大分県","宮崎県","鹿児島県","沖縄県"];
        ...
        Container(width:double.infinity,height: 20 ,margin: EdgeInsets.only(top:5), child: Text("市町村",style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 15),textAlign: TextAlign.center,),),
        Container(width:double.infinity,height: 40 ,color: Colors.grey[100],margin: EdgeInsets.all(10),child:TextFormField(onTap: () { _loadData();FocusScope.of(context).requestFocus(new FocusNode());tap = 2;showPicker();},controller: ShityoCon,decoration: InputDecoration(labelText: '選択'),
          onChanged: (String value) {setState(() {});},),),
        Container(child: Text("ID検索")),
        Container(child:TextFormField( decoration: InputDecoration(hintText: '施術者からIDを聞いてください。'), obscureText: true,
          onChanged: (String value) {setState(() {password = value;});},),),
    Container(margin: EdgeInsets.only(top:20,bottom: 5),
    child: ElevatedButton(
    child: const Text('検索'),
    style: ElevatedButton.styleFrom(primary: Colors.blue, onPrimary: Colors.white, shape: const StadiumBorder(),),
    onPressed: () {search();},
    ),),
        Center(child: Visibility(visible: aka,
            child: Container(  decoration: BoxDecoration(border: Border.all(color: Colors.grey), borderRadius: BorderRadius.circular(10),),
              child: Column(children: [
                                Row(children: [
                                  Container(height: 200,width: 150, decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),
                                    image: DecorationImage(image: AssetImage("images/asami.JPG"), fit: BoxFit.fill,),)),
  ...
  void search (){
      item = [];
      FirebaseFirestore.instance.collection("施術者").doc(Shityo).collection("施術者").where("コード",isEqualTo: password).get().then((QuerySnapshot snapshot) {
...
class _V1State extends State<V1> {
          ...
          child: Container(
              child: Column(
                children: [
                  Container(margin: EdgeInsets.only(top:20,bottom: 5),
                    child: ElevatedButton(
                      child: const Text('絶対条件'),
                      style: ElevatedButton.styleFrom(primary: Colors.yellow[800], onPrimary: Colors.white, shape: const StadiumBorder(),),
                      onPressed: () {search();},
                    ),),
                  Container(margin:EdgeInsets.all(10),child:Text("エリアを絞る",style: TextStyle(fontWeight: FontWeight.bold,color:Colors.black),)),
                            ...
                            child: Container(
                              ...
                              child: MaterialButton(
                                ...
                                onPressed: () {   Navigator.of(context).push(
                                  MaterialPageRoute(builder: (context) => V1V2("北海道")),);
                                },
                              ),
                            ),)),
                      Expanded(
                              ...
                              child: MaterialButton(
                                ...
                                onPressed: () {
                                  Navigator.of(context).push(
                                    MaterialPageRoute(builder: (context) => V1V2("東北")),);
                                },
                              ),),)),
                      Expanded(
                          child: AspectRatio(
                            ...
                            child: Container(
                              ...
                              child: MaterialButton(
                                ...
                                onPressed: () {
                                  Navigator.of(context).push(
                                    MaterialPageRoute(builder: (context) => V1V2("北信越")),);
                                },
                              ),),)),
                    ],), Container(
                    child: Row(
                            ...
                            child: AspectRatio(
                              ...
                              child: Container(
                                ...
                                child: MaterialButton(
                                  ...
                                  onPressed: () {Navigator.of(context).push(
                                    MaterialPageRoute(builder: (context) => V1V2("関東")),);
                                  },
                                ),
                              ),)),
                        Expanded(
                              ...
                              child: Container(
                                ...
                                child: MaterialButton(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text("東海",textAlign: TextAlign.center,),
                                  ),
                                  onPressed: () {
                                    Navigator.of(context).push(
                                      MaterialPageRoute(builder: (context) => V1V2("東海")),);
                                  },
                                ),),)),
                        Expanded(
                            child: AspectRatio(
                              ...
                              child: Container(
                                ...
                                child: MaterialButton(
                                  ...
                                  onPressed: () {
                                    Navigator.of(context).push(
                                      MaterialPageRoute(builder: (context) => V1V2("近畿")),);
                                  },
                                ),),)),
                      ],),), Container(
                    child: Row(
                            ...
                            child: AspectRatio(
                              ...
                              child: Container(
                                ...
                                child: MaterialButton(
                                  ...
                                  onPressed: () {Navigator.of(context).push(
                                    MaterialPageRoute(builder: (context) => V1V2("中国")),);
                                  },
                                ),
                              ),)),
                        Expanded(
                            child: AspectRatio(
                              ...
                              child: Container(
                                ...
                                child: MaterialButton(
                                  ...
                                  onPressed: () {Navigator.of(context).push(
                                    MaterialPageRoute(builder: (context) => V1V2("四国")),);}
                                ),),)),
                        Expanded(
                            child: AspectRatio(
                              aspectRatio: 1,
                              child: Container(
                                ...
                                child: MaterialButton(
                                  ...
                                  onPressed: () {
                                    Navigator.of(context).push(
                                      MaterialPageRoute(builder: (context) => V1V2("九州・沖縄")),);
                                  },
                                ),),))
                      ],),),
                ],)),
  ...
  void search(){
    final tags = ["今日行ける","女性スタッフ","男性スタッフ","美容ばり","女性限定治療院","クレジットカード","駐車場あり","保険治療","月曜診察","火曜診察","水曜診察","木曜診察","金曜診察","土曜診察","日曜診察","祝日診察","モニター実施"];
    showDialog(context: context, builder: (context) =>
        AlertDialog(
          title: Text("絶対条件",textAlign: TextAlign.center,style: TextStyle(fontWeight: FontWeight.bold,),),
          actions: <Widget>[
              Center(//margin: EdgeInsets.all(10),
              child: Wrap(
