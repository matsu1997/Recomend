...
class _MedicalQuestionState extends State<MedicalQuestion > {
  ...
  var list = [];
  var item = ["首肩こり","腰痛","","","","","","","",];
  var item0 = ["頭痛","薄毛","脳梗塞","めまい","顔面神経麻痺","眼精疲労","仮性近視","白内障","メニエール","耳鳴り","副鼻腔炎","鼻炎","花粉症","歯痛",];
  var item1 = ["むち打ち症","寝違い","首肩こり","四・五十肩","野球肩","背部痛","腕の痺れ","ゴルフ・テニス肘","腱鞘炎","リウマチ"];
  var item2 = ["慢性腰痛","ぎっくり腰","椎間板ヘルニア"];
  var item3 = ["股関節痛","坐骨神経痛","変形性膝関節症","膝痛","むくみ","冷え性","アキレス腱炎","シンスプリント","捻挫","足底筋膜炎",];
  var item4 = ["胃炎・胃痛","胃下垂","胃もたれ","食欲不振","口内炎","胆石症","便秘","下痢","高血圧","低血圧","動悸","むくみ", "冷え性"];
  var item5 = ["生理痛","生理不順","月経異常","更年期障害","冷え","のぼせ","つわり","不妊","PMS(生理前症候群)","貧血","逆子","骨盤の歪み"];
  var item6 = ["小児喘息","夜尿症","夜泣き","かんの虫","虚弱体質"];
  var item7 = ["自律神経失調","不眠症","ストレス","アレルギー","アトピー性皮膚","風邪","扁桃炎","気管支炎","喘息","咳","不眠","動悸","イライラ"];
  ...
  Widget build(BuildContext context) {
    return Scaffold( backgroundColor: Colors.white,
      ...
      body: SingleChildScrollView(child: Column(children: [
        Container(width:double.infinity,height: 30 ,margin: EdgeInsets.only(top:10), child: Text("多い症状",style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),textAlign: TextAlign.center,),),
        GridView.count(
            ...
            children: List.generate(item.length, (index) {
              return GestureDetector(onTap: () {Navigator.of(context).push(MaterialPageRoute(builder: (context) => MedicalQuestion1(item0[index]))); },
                child:Container(alignment: Alignment.center,color: Colors.grey[100],
                    // decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(10)),
                    child:Text(item[index],style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),)),
              );})),

        Container(width:double.infinity,height: 30 ,margin: EdgeInsets.only(top:10), child: Text("頭の症状",style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),textAlign: TextAlign.center,),),
        GridView.count(
          padding: EdgeInsets.all(10.0), crossAxisCount: 2, crossAxisSpacing: 5.0,mainAxisSpacing: 10.0,childAspectRatio: 3.0,
          shrinkWrap: true,physics: NeverScrollableScrollPhysics(),
        ...
        Container(width:double.infinity,height: 30 ,margin: EdgeInsets.only(top:10), child: Text("首-腕の症状",style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),textAlign: TextAlign.center,),),
        GridView.count(
            padding: EdgeInsets.all(10.0), crossAxisCount: 2, crossAxisSpacing: 5.0,mainAxisSpacing: 10.0,childAspectRatio: 3.0,
            shrinkWrap: true,physics: NeverScrollableScrollPhysics(),
            children: List.generate(item1.length, (index) {
              return GestureDetector(onTap: () {    Navigator.of(context).push(MaterialPageRoute(builder: (context) => MedicalQuestion1(item1[index])));},
                child:Container(alignment: Alignment.center,color: Colors.grey[100],
                      child:Text(item1[index],style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),)),
              );})),

        Container(width:double.infinity,height: 30 ,margin: EdgeInsets.only(top:10), child: Text("背中の症状",style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),textAlign: TextAlign.center,),),
        GridView.count(
            padding: EdgeInsets.all(10.0), crossAxisCount: 2, crossAxisSpacing: 5.0,mainAxisSpacing: 10.0,childAspectRatio: 3.0,
            shrinkWrap: true,physics: NeverScrollableScrollPhysics(),
            children: List.generate(item2.length, (index) {
              return GestureDetector(onTap: () {    Navigator.of(context).push(MaterialPageRoute(builder: (context) => MedicalQuestion1(item2[index]))); },
                child:Container(alignment: Alignment.center,color: Colors.grey[100],
                      child:Text(item2[index],style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),)),
              );})),

        Container(width:double.infinity,height: 30 ,margin: EdgeInsets.only(top:10), child: Text("下肢の症状",style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),textAlign: TextAlign.center,),),
        GridView.count(
            padding: EdgeInsets.all(10.0), crossAxisCount: 2, crossAxisSpacing: 5.0,mainAxisSpacing: 10.0,childAspectRatio: 3.0,
            shrinkWrap: true,physics: NeverScrollableScrollPhysics(),
            children: List.generate(item3.length, (index) {
              return GestureDetector(onTap: () {    Navigator.of(context).push(MaterialPageRoute(builder: (context) => MedicalQuestion1(item3[index]))); },
                child:Container(alignment: Alignment.center,color: Colors.grey[100],
                    // decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(10)),
                    child:Text(item3[index],style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),)),
              );})),

        Container(width:double.infinity,height: 30 ,margin: EdgeInsets.only(top:10), child: Text("内臓・循環器の症状",style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),textAlign: TextAlign.center,),),
        GridView.count(
            padding: EdgeInsets.all(10.0), crossAxisCount: 2, crossAxisSpacing: 5.0,mainAxisSpacing: 10.0,childAspectRatio: 3.0,
            shrinkWrap: true,physics: NeverScrollableScrollPhysics(),
            children: List.generate(item4.length, (index) {
              return GestureDetector(onTap: () {   Navigator.of(context).push(MaterialPageRoute(builder: (context) => MedicalQuestion1(item4[index]))); },
                child:Container(alignment: Alignment.center,color: Colors.grey[100],
                       child:Text(item4[index],style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),)),
              );})),

        Container(width:double.infinity,height: 30 ,margin: EdgeInsets.only(top:10), child: Text("婦人科の症状",style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),textAlign: TextAlign.center,),),
        GridView.count(
            padding: EdgeInsets.all(10.0), crossAxisCount: 2, crossAxisSpacing: 5.0,mainAxisSpacing: 10.0,childAspectRatio: 3.0,
            shrinkWrap: true,physics: NeverScrollableScrollPhysics(),
            children: List.generate(item5.length, (index) {
              return GestureDetector(onTap: () {   Navigator.of(context).push(MaterialPageRoute(builder: (context) => MedicalQuestion1(item5[index]))); },
                child:Container(alignment: Alignment.center,color: Colors.grey[100],
                                child:Text(item5[index],style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),)),
              );})),

        Container(width:double.infinity,height: 30 ,margin: EdgeInsets.only(top:10), child: Text("小児科の症状",style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),textAlign: TextAlign.center,),),
        GridView.count(
            padding: EdgeInsets.all(10.0), crossAxisCount: 2, crossAxisSpacing: 5.0,mainAxisSpacing: 10.0,childAspectRatio: 3.0,
            shrinkWrap: true,physics: NeverScrollableScrollPhysics(),
            children: List.generate(item6.length, (index) {
              return GestureDetector(onTap: () {    Navigator.of(context).push(MaterialPageRoute(builder: (context) => MedicalQuestion1(item6[index]))); },
                child:Container(alignment: Alignment.center,color: Colors.grey[100],
                            child:Text(item6[index],style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),)),
              );})),

        Container(width:double.infinity,height: 30 ,margin: EdgeInsets.only(top:10), child: Text("全身の症状",style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),textAlign: TextAlign.center,),),
        GridView.count(
            padding: EdgeInsets.all(10.0), crossAxisCount: 2, crossAxisSpacing: 5.0,mainAxisSpacing: 10.0,childAspectRatio: 3.0,
            shrinkWrap: true,physics: NeverScrollableScrollPhysics(),
            children: List.generate(item7.length, (index) {
              return GestureDetector(onTap: () {Navigator.of(context).push(MaterialPageRoute(builder: (context) => MedicalQuestion1(item7[index]))); },
                child:Container(alignment: Alignment.center,color: Colors.grey[100],
                     child:Text(item7[index],style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),)),
              );})),
        Container(width:double.infinity,height: 30 ,margin: EdgeInsets.only(top:10), child: Text("その他のお悩み",style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),textAlign: TextAlign.center,),),
        Container(color: Colors.grey[100],width:double.infinity,height: 50,margin: EdgeInsets.all(10),child:TextFormField(decoration: InputDecoration(labelText: '入力'),
          onChanged: (String value) {setState(() {coment = value;});},),),
        Container(margin: EdgeInsets.only(top:10,bottom: 20),
          child: ElevatedButton(
            ...
            onPressed: () {Navigator.of(context).push(MaterialPageRoute(builder: (context) => MedicalQuestion1(coment))); },
          ),),
      ],),));}
}
...
class MedicalQuestion1 extends StatefulWidget {
  MedicalQuestion1(this.Q1);
  String Q1;
  @override
  State<MedicalQuestion1> createState() => _MedicalQuestion1State();
}
class _MedicalQuestion1State extends State<MedicalQuestion1 > {
  var index1 = 0;
  var coment = "";
  var Id = "";
  var when = "";var time = "";var Shisei = "";var Raku = "";var Gen = "";
  var list = [];
  var item = ["昨日","一昨日","1週間ほど前","1ヶ月以内","一ヶ月以上","わからない"];
  //var item1 =["","","","","",""];
  var item1 =["朝","昼","夜","不定期","時間に関係しない"];
  var item2 =["座る","立つ","横になる","(患部を)曲げる","(患部を)伸ばす","(患部を)反らす","(患部を)捻る","(患部を)倒す"];
  var item3 =["お風呂","横になる","睡眠","","",""];
  var item4 =["デスクワーク","立ち仕事","運動","","",""];
  @override
  void initState() {
    super.initState();
  }
  Widget build(BuildContext context) {
    return Scaffold( backgroundColor: Colors.white,
        appBar: AppBar(
          backgroundColor: Colors.white,
          title: Text(widget.Q1,style: TextStyle(fontWeight: FontWeight.bold,color:Colors.black),),
          iconTheme: IconThemeData(color: Colors.black),
          elevation: 0, centerTitle: true,
        ),
        body: SingleChildScrollView(child: Column(children: [

          Container(width:double.infinity,height: 30 ,margin: EdgeInsets.only(top:10), child: Text("いつから？["+ when+"]",style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),textAlign: TextAlign.center,),),
          GridView.count(
              padding: EdgeInsets.all(10.0), crossAxisCount: 2, crossAxisSpacing: 5.0,mainAxisSpacing: 10.0,childAspectRatio: 3.0,
              shrinkWrap: true,physics: NeverScrollableScrollPhysics(),
              children: List.generate(item.length, (index) {
                return GestureDetector(onTap: () {setState(() { when = item[index];});},
                  child:Container(alignment: Alignment.center,color: Colors.grey[100],
                      child:Text(item[index],style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),)),
                );})),

          Container(width:double.infinity,height: 30 ,margin: EdgeInsets.only(top:10), child: Text("辛い時間帯は？["+ time+"]",style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),textAlign: TextAlign.center,),),
          GridView.count(
              padding: EdgeInsets.all(10.0), crossAxisCount: 2, crossAxisSpacing: 5.0,mainAxisSpacing: 10.0,childAspectRatio: 3.0,
              shrinkWrap: true,physics: NeverScrollableScrollPhysics(),
              children: List.generate(item1.length, (index) {
                return GestureDetector(onTap: () { setState(() {time = item1[index];}); },
                  child:Container(alignment: Alignment.center,color: Colors.grey[100],
                      child:Text(item1[index],style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),)),
                );})),
          Container(width:double.infinity,height: 30 ,margin: EdgeInsets.only(top:10), child: Text("特に辛い姿勢は？["+ Shisei+"]",style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),textAlign: TextAlign.center,),),
          GridView.count(
              padding: EdgeInsets.all(10.0), crossAxisCount: 2, crossAxisSpacing: 5.0,mainAxisSpacing: 10.0,childAspectRatio: 3.0,
              shrinkWrap: true,physics: NeverScrollableScrollPhysics(),
              children: List.generate(item2.length, (index) {
                return GestureDetector(onTap: () { setState(() {Shisei = item2[index];}); },
                  child:Container(alignment: Alignment.center,color: Colors.grey[100],
                      child:Text(item2[index],style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),)),
                );})),
            Container(color: Colors.grey[100],width:double.infinity,height: 50,margin: EdgeInsets.all(10),child:TextFormField(decoration: InputDecoration(labelText: 'その他'),
            onChanged: (String value) {setState(() {Shisei = value;});},),),

          Container(width:double.infinity,height: 30 ,margin: EdgeInsets.only(top:10), child: Text("楽になるのは？["+ Raku+"]",style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),textAlign: TextAlign.center,),),
          GridView.count(
              padding: EdgeInsets.all(10.0), crossAxisCount: 2, crossAxisSpacing: 5.0,mainAxisSpacing: 10.0,childAspectRatio: 3.0,
              shrinkWrap: true,physics: NeverScrollableScrollPhysics(),
              children: List.generate(item3.length, (index) {
                return GestureDetector(onTap: () {  Raku = item3[index];},
                  child:Container(alignment: Alignment.center,color: Colors.grey[100],
                      child:Text(item3[index],style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),)),
                );})),
          Container(color: Colors.grey[100],width:double.infinity,height: 50,margin: EdgeInsets.all(10),child:TextFormField(decoration: InputDecoration(labelText: 'その他'),
            onChanged: (String value) {setState(() {Raku = value;});},),),

          Container(width:double.infinity,height: 30 ,margin: EdgeInsets.only(top:10), child: Text("思い当たる原因は？["+ Gen+"]",style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),textAlign: TextAlign.center,),),
          GridView.count(
              padding: EdgeInsets.all(10.0), crossAxisCount: 2, crossAxisSpacing: 5.0,mainAxisSpacing: 10.0,childAspectRatio: 3.0,
              shrinkWrap: true,physics: NeverScrollableScrollPhysics(),
              children: List.generate(item4.length, (index) {
                return GestureDetector(onTap: () { setState(() {Gen = item4[index];}); },
                  child:Container(alignment: Alignment.center,color: Colors.grey[100],
                      child:Text(item4[index],style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),)),
                );})),
          Container(color: Colors.grey[100],width:double.infinity,height: 50,margin: EdgeInsets.all(10),child:TextFormField(decoration: InputDecoration(labelText: 'その他'),
            onChanged: (String value) {setState(() {Gen = value;});},),),
  ...
  Future<void> add() async {
     ...
     var uid = prefs.getString("uid")?? "";
      await FirebaseFirestore.instance.collection('users').doc(uid).collection("主症状").doc(Id).set({
        "uid":uid,"Id":Id,
        "主症状":widget.Q1,"いつ":when,"時間帯":time,"姿勢":Shisei,"楽":Raku,"原因":Gen,
...
class MedicalQuestionBase extends StatefulWidget {
  @override
  State<MedicalQuestionBase> createState() => _MedicalQuestionBaseState();
}
class _MedicalQuestionBaseState extends State<MedicalQuestionBase > {
  var index1 = 0;
  var tap = 0;
  var list = [];
  List<String> Base = [] ;
  ...
  var item0 = ["男性","女性"];
  //var item1 =["","","","","",""];
  var item1 =["10歳未満","10代","20代","30代","40代","50代","60歳以上"];
  var item2 =["座る","立つ","横になる","前屈み","体を反らす","体を捻る",""];
  var item3 =["お風呂","横になる","睡眠","","",""];
  var item4 =["デスクワーク","立ち仕事","運動","","",""];
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return Scaffold( backgroundColor: Colors.white,
        appBar: AppBar(
          backgroundColor: Colors.white,
          title: Text("問診票(基礎)",style: TextStyle(fontWeight: FontWeight.bold,color:Colors.black),),
          iconTheme: IconThemeData(color: Colors.black),
          elevation: 0, centerTitle: true,
        ),
        body: SingleChildScrollView(child: Column(children: [
          ...
          Container(color: Colors.grey[100],width:double.infinity,height: 50,margin: EdgeInsets.all(10),child:TextFormField(controller: nameCon,decoration: InputDecoration(labelText: '入力'),
            onChanged: (String value) {setState(() {name = value;});},),),
          Container(width:double.infinity,height: 30 ,margin: EdgeInsets.only(top:10), child: Text("性別",style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),textAlign: TextAlign.center,),),
          GridView.count(
              padding: EdgeInsets.all(10.0), crossAxisCount: 2, crossAxisSpacing: 5.0,mainAxisSpacing: 10.0,childAspectRatio: 3.0,
              shrinkWrap: true,physics: NeverScrollableScrollPhysics(),
              children: List.generate(item0.length, (index) {
                return GestureDetector(onTap: () {sex = item0[index]; },    child:Container(alignment: Alignment.center,color: Colors.grey[100],
                      // decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(10)),
                      child:Text(item0[index],style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),)),
                );})),
          Container(width:double.infinity,height: 30 ,margin: EdgeInsets.only(top:10), child: Text("年齢",style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),textAlign: TextAlign.center,),),
          GridView.count(
              padding: EdgeInsets.all(10.0), crossAxisCount: 2, crossAxisSpacing: 5.0,mainAxisSpacing: 10.0,childAspectRatio: 3.0,
              shrinkWrap: true,physics: NeverScrollableScrollPhysics(),
              children: List.generate(item1.length, (index) {
                return GestureDetector(onTap: () {age = item1[index]; },
                  child:Container(alignment: Alignment.center,color: Colors.grey[100],
                            child:Text(item1[index],style: TextStyle(color: Colors.blueGrey[900],fontWeight: FontWeight.bold,fontSize: 20),)),
                );})),
  ...
  Future<void> Add () async {
    SharedPreferences prefs = await SharedPreferences.getInstance();prefs.setStringList("基礎", [name,sex,age,Ken,Shityo,Rosen,Eki]);}
  void showPicker() {
...
class MedicalQuestionElse extends StatefulWidget {
  @override
  State<MedicalQuestionElse> createState() => _MedicalQuestionElseState();
}
class _MedicalQuestionElseState extends State<MedicalQuestionElse> {
  var index1 = 0;
  var tap = 0;
  var coment = "";
  var list = [];
  final TextEditingController _controller = TextEditingController();
  final tags = ["冷え性","むくみ","立ちくらみ","頭痛(ズキズキ)","頭痛(締めつける)","頭がぼーっとする","食いしばり","食欲不振","胃腸が弱い","腹痛が多い","お腹が張る","便秘が多い","下痢が多い","下痢と便秘を繰り返す","汗を良くかく","汗をかきにくい","暑がり","寒がり","寝汗をかく","顔に汗をかく","手足に汗をかく","手足のほてり","顔のほてり","口が乾く","喉が乾く","乾燥肌","イライラする","気分が落ち込む"
    ,"雨の前後に体調が悪くなる","雨の日に体調が悪くなる","季節の変わり目に体調が悪くなる","鼻づまり","鼻水","喉が詰まる","動悸","手の痺れ","足の痺れ"];
  ...
  Widget build(BuildContext context) {
    return Scaffold( backgroundColor: Colors.white,
        appBar: AppBar(
          backgroundColor: Colors.white,
          title: Text("問診票(副症状)",style: TextStyle(fontWeight: FontWeight.bold,color:Colors.black),),
          iconTheme: IconThemeData(color: Colors.black),
          elevation: 0, centerTitle: true,
        ),
        body: SingleChildScrollView(child: Column(children: [
                ...
                return InkWell(
                  ...
                  child: AnimatedContainer(
                    ...
                    child: Text(tag, style: TextStyle(
                      color: isSelected ? Colors.white : Colors.blueGrey, fontWeight: FontWeight.bold,
                    ),),),);}).toList(),
            ),),
  ...
  Future<void> Set () async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setStringList("副症状",selectedTags); print(selectedTags);}
}